...
class MemoryClient:
    ...
    async def _async_request(self, method: str, url: str, **kwargs):
        ...
        if hasattr(self.brain_client, "_async_request"):
            return await self.brain_client._async_request(method, url, **kwargs)
    ...
    async def set(self, key: str, data: Any, scope: Optional[str] = None) -> None:
        ...
        try:
            if hasattr(self.brain_client, "_async_request"):
                response = await self.brain_client._async_request(
                    "POST",
                    url,
                    json=payload,
                    headers=headers,
